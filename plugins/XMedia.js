...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'x4mp4', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.mp4'), MessageType.video, {caption: '★ 𝙼𝚊𝚍𝚎 𝚋𝚢 𝙹𝚎𝚜𝚜𝚒𝚎 💝🔥'});
            });
    ...
    Asena.addCommand({pattern: 'mp4image', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.mp4'), MessageType.video, {mimetype: Mimetype.mpeg, caption: '★ 𝙼𝚊𝚍𝚎 𝚋𝚢 𝙹𝚎𝚜𝚜𝚒𝚎 💝🔥'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
    ...
    Asena.addCommand({pattern: 'bwimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.jpg')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.jpg'), MessageType.image, {mimetype: Mimetype.jpg, caption: '★ 𝙼𝚊𝚍𝚎 𝚋𝚢 𝙹𝚎𝚜𝚜𝚒𝚎 💝🔥'});
        });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
    ...
    Asena.addCommand({pattern: 'gif', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output_gif.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output_gif.mp4'), MessageType.video, {mimetype: Mimetype.gif, caption: '★ 𝙼𝚊𝚍𝚎 𝚋𝚢 𝙹𝚎𝚜𝚜𝚒𝚎 💝🔥'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
    ...
    Asena.addCommand({pattern: 'mp4slowmo', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('slowmo.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('slowmo.mp4'), MessageType.video, {caption: 'True Slow-Motion by 𝙹𝚎𝚜𝚜𝚒𝚎 💝🔥'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
}
    ...
    Asena.addCommand({pattern: 'xmedia', fromMe: false, desc: Lang.XMEDİA_DESC}, (async (message, match) => {    
       ...
       await message.sendMessage('●▬*𝓙𝓮𝓼𝓼𝓲𝓮 𝙲𝚘𝚖𝚖𝚊𝚗𝚍-𝙻𝚒𝚜𝚝*☯▬●\n\n🎯 Command: *.yt*\n📝 Description:```It searches on YouTube.```\n\n🎯 Command: *.song Enter_Your_Song_Name*\n📝 Description:```Uploads the song you wrote.```\n\n🎯 Command: *.song YoutubeVideo_Link*\n📝 Description:```Download Youtube  video to mp3.```\n\n🎯 Command: *.video YoutubeVideo_Link*\n📝 Description:```Downloads video from YouTube.\n⚠️( Please Less than 30 minutes in your youtube video)```\n\n🎯 Command: *.mp4audio*\n📝 Description:```It converts video to sound.```\n\n🎯 Command: *.tts*\n📝 Description:```It converts text to sound.```\n\n🎯 Command: *.sticker*\n📝 Description:```It converts your replied photo to a sticker. Put a sticker and mention sticker and type command.```\n\n🎯 Command: *.attp*\n📝 Description:```Adds rainbow effect to the text as a sticker.```\n\n🎯 Command: *.imagesticker*\n📝 Description:```Converts the sticker to a photo. Put a sticker and mention sticker and type command.```\n\n🎯 Command: *.ttp*\n📝 Description:```Converts text to plain painting.```\n\n🎯 Command: *.trumpsay*\n📝 Description:```Converts the text to Trumps tweet.```\n\n🎯 Command: *.removebg*\n📝 Description:```Removes the background of the photos.```\n\n🎯 Command: *.meme*\n📝 Description:```Photo memes you replied to.```\n\n🎯 Command: *.wallpaper*\n📝 Description:```It sends high resolution random wallpapers.```\n\n🎯 Command: *.randanime*\n📝 Description:```It sends high resolution Random Anime images.```\n\n🎯 Command: *.bwimage*\n📝 Description:```Applies a black and white effect to image```\n\n🎯 Command: *.rainbowbg*\n📝 Description:```Converts the text into rainbowbg image```\n\n🎯 Command: *.bneon*\n📝 Description:```Converts the text into background neon image```\n\n🎯 Command: *.ttok*\n📝 Description:```Converts the text into tiktok style image```\n⌨️ *Example:*.ttok TEXT1/TEXT2\n\n🎯 Command: *.thunder*\n📝 Description:```It Sends a thunder carved image of the text provided.```\n\n🎯 Command: *.marvel*\n📝 Description:```It Sends Marvel image of the text provided.```\n⌨️ *Example:*.ttok TEXT1/TEXT2\n\n🎯 Command: *.eimg*\n📝 Description:```It Convert Emoji to Image.```\n\n🎯 Command: *.3dbox*\n📝 Description:```It Sends 3D Box Style image of the text provided.```\n\n🎯 Command: *.phub*\n📝 Description:```It Sends P*rn hub style image of the text provided.```\n\n🎯 Command: *.page*\n📝 Description:```It Sends a page style image of the text provided.```\n\n🎯 Command: *.weather*\n📝 Description:```This shows the weather in your City.```\n⌨️ *Example:*.weather Colombo\n\n🎯 Command: *.ocr*\n📝 Description:```Reads the text on the photo you have replied to. It works English Languages Photo. Not Support Sinhala.```\n\n🎯 Command: *.scan*\n📝 Description:```Checks whether the entered number is registered on Whatsapp.```\n\n🎯 Command: *.trt*\n📝 Description:```It translates with Google Translate. You must reply to any message.```\n*⌨️ Example:*.trt en si (From English to Sinhala)\n\n🎯 Command: *.ss*\n📝 Description:```Takes a screenshot from the page in the given link.```\n\n🎯 Command: *.quote*\n📝 Description:```It Sends Random Quote.```\n\n🎯 Command: *.activity*\n📝 Description:```It Sends Random Activity You can do```\n\n🎯 Command: *.jokes*\n📝 Description:```It Sends Random Joke```\n\n🎯 Command: *.whois*\n📝 Description:```Displays metadata data of group or person.```\n\n🎯 Command: *.lyrics*\n📝 Description:```Brings you the song Lyrics.```\n\n🎯 Command: *.matrix*\n📝 Description:```Converts the text into matrix themed image.```\n\n🎯 Command: *.covid*\n📝 Description:```Shows the Daily and Overall Covid table of Countries.```\n⌨️ *Example:*.covid World\n\n🎯 Command: *.movie*\n📝 Description:```It Sends MOVIE all Details```\n⌨️ *Example:*.movie Radhe\n\n⭕ ```Can Use Only English Characters...!```\n\n⚠️ ```Warning...!```\n *Please, Do not Access to Use Private Use this bot* ❌\n*Using the bot out of purpose will explicitly ban you.*\n\n*𝓙𝓮𝓼𝓼𝓲𝓮 Bot Owner* - 𝚃𝚑𝚊𝚛𝚒𝚗𝚍𝚞 𝙳𝚑𝚊𝚗𝚞𝚜𝚑𝚔𝚊\n𝒞𝑜𝓃𝓉𝒶𝒸𝓉 𝓂𝑒 - wa.me/+94769183064');
    ...
    Asena.addCommand({pattern: 'mp4slowmo', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('slowmo.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('slowmo.mp4'), MessageType.video, {caption: 'True Slow-Motion by 𝓙𝓮𝓼𝓼𝓲𝓮 🔥'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
    ...
    Asena.addCommand({pattern: 'mp4img', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'bwimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.jpg')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.jpg'), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made by 𝓙𝓮𝓼𝓼𝓲𝓮 🔥'});
        });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));

    Asena.addCommand({pattern: 'vintageimg', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'mp4enhanc', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'blurimg', fromMe: true, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Asena.addCommand({pattern: 'mp4blurvideo', fromMe: true, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Asena.addCommand({pattern: 'edgeimg', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'enhanceimg', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'grenimg', fromMe: true, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Asena.addCommand({pattern: 'rainbowimg', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'mp4rainbowv', fromMe: true, dontAddCommandList: true}, (async (message, match) => {  
    ...
    Asena.addCommand({pattern: 'negativeimg', fromMe: true, dontAddCommandList: true}, (async (message, match) => {  
    ...
    Asena.addCommand({pattern: 'mp4negativev', fromMe: true, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Asena.addCommand({pattern: 'artimg', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'mp4colors', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'colorimg', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'mp4slowmot', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
